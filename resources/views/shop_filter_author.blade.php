                ...
                <div class="col-6 col-sm-6 col-lg-2">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            @foreach($filter_author as $key => $book_filter_author)
                            <li><a class="dropdown-item"
                                    href="{{URL::to('/book-author/'.$book_filter_author->author_id)}}">Sort
                                    by on sale </a>
                            </li>
                            @endforeach
                            <li><a class="dropdown-item"
                                    href="{{URL::to('/book-author-show-popularity/'.$book_filter_author->author_id)}}">Sort
                                    by popularity</a>
                            </li>
                            <li><a class="dropdown-item"
                                    href="{{URL::to('/book-author-show-high/'.$book_filter_author->author_id)}}">Sort
                                    by price: low to high </a>
                            </li>
                            <li><a class="dropdown-item"
                                    href="{{URL::to('/book-author-show-low/'.$book_filter_author->author_id)}}">Sort
                ...
                <div class="col-4 col-sm-6 col-lg-1">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            @foreach($author_number as $key => $number)
                            <li><a class="dropdown-item"
                                    href="{{URL::to('/book-author/'.$number->id.'/'.$sort_type_id)}}">Show 25</a></li>
                            <li><a class="dropdown-item"
                                    href="{{URL::to('/book-author-show-20/'.$number->id.'/'.$sort_type_id)}}">Show
                                    20</a>
                            </li>
                            <li><a class="dropdown-item"
                                    href="{{URL::to('/book-author-show-15/'.$number->id.'/'.$sort_type_id)}}">Show
                                    15</a>
                            </li>
                            <li><a class="dropdown-item"
                                    href="{{URL::to('/book-author-show-5/'.$number->id.'/'.$sort_type_id)}}">Show 5</a>
                            </li>
                            @endforeach
                        </ul>
                    </div>
