    ...
    <div class="row" style="margin-right:20px;">
        ...
        <div class="col-6 col-sm-6 col-lg-1">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    <li><a class="dropdown-item" href="{{URL::to('/shop-show-popularity')}}">Show 25</a></li>
                    <li><a class="dropdown-item" href="{{URL::to('/shop-show-popularity-20')}}">Show 20</a></li>
                    <li><a class="dropdown-item" href="{{URL::to('/shop-show-popularity-15')}}">Show 15</a></li>
                    <li><a class="dropdown-item" href="{{URL::to('/shop-show-popularity-5')}}">Show 5</a></li>
                </ul>
            </div>
        </div>
    </div>
