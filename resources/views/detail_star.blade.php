                ...
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-8">
                        <div class="shadow-none p-3 mb-5 bg-light rounded">
                            @foreach($star_number as $key => $star)
                            <p><strong style="font-size:20px;">Customer Reviews</strong> (Filtered by
                                {{$star->rating_start}} star)</p>
                            @endforeach
                            <h1>{{$average}} Star</h1>
                            <div class="row">
                                <div class="col-12 col-sm-2 col-lg-1">
                                    <p><a
                                            href="{{URL::to('/book-detail-show-new/'.$book->id)}}"><u><strong>(All)</strong></u></a>
                                    </p>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col col-sm-3 col-lg-3">
                                    <div class="dropdown">
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            {{ $sort_type }}
                                            <?php
                                            if($sort_type == 'Sort by date: newest to oldest'){
                                                $sort_type_id = 1;
                                            } elseif($sort_type == 'Sort by on sale'){
                                                $sort_type_id = 2;
                                            } else {
                                                $sort_type_id = 3;
                                            }
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li><a class="dropdown-item"
                                                    href="{{URL::to('/book-detail-show-star-review-new/'.$book->id.'/'.$star->rating_start)}}">Sort
                                                    by date: newest to oldest </a>
                                            </li>
                                            <li><a class="dropdown-item"
                                                    href="{{URL::to('/book-detail-show-star-review/'.$book->id.'/'.$star->rating_start)}}">Sort
                                                    by on sale</a>
                                            </li>
                                            <li><a class="dropdown-item"
                                                    href="{{URL::to('/book-detail-show-star-review-old/'.$book->id.'/'.$star->rating_start)}}">Sort
                                                    by date: oldest to newest </a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="col col-sm-1 col-lg-1">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        @foreach($star_number as $key => $star)
                                        <li><a class="dropdown-item" href="{{URL::to('/book-detail-star-review/'.$star->book_id.'/'.$star->rating_start.'/'.$sort_type_id)}}">Show 20</a></li>
                                        <li><a class="dropdown-item" href="{{URL::to('/book-detail-star-review-show-15/'.$star->book_id.'/'.$star->rating_start.'/'.$sort_type_id)}}">Show 15</a></li>
                                        <li><a class="dropdown-item" href="{{URL::to('/book-detail-star-review-show-10/'.$star->book_id.'/'.$star->rating_start.'/'.$sort_type_id)}}">Show 10</a></li>
                                        <li><a class="dropdown-item" href="{{URL::to('/book-detail-star-review-show-5/'.$star->book_id.'/'.$star->rating_start.'/'.$sort_type_id)}}">Show 5</a></li>
                                        @endforeach
                                        </ul>
                                    </div>
                                </div>
