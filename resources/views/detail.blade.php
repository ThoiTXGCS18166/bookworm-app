                        ...
                        <div class="shadow-none p-3 mb-5 bg-light rounded">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-2 col-lg-1">
                                    <p><a
                                            href="{{URL::to('/book-detail/'.$book->id)}}"><u><strong>(All)</strong></u></a>
                                    </p>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col col-sm-1 col-lg-1">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li><a class="dropdown-item"
                                                    href="{{URL::to('/book-detail/'.$book->id)}}">Show 20</a></li>
                                            <li><a class="dropdown-item"
                                                    href="{{URL::to('/book-detail-show-15/'.$book->id)}}">Show 15</a>
                                            </li>
                                            <li><a class="dropdown-item"
                                                    href="{{URL::to('/book-detail-show-10/'.$book->id)}}">Show 10</a>
                                            </li>
                                            <li><a class="dropdown-item"
                                                    href="{{URL::to('/book-detail-show-5/'.$book->id)}}">Show 5</a></li>
                                        </ul>
                                    </div>
                                </div>
