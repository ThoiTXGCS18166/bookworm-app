...
<body>
    ...
    <main>
        ...
        <div class="centered-btn">
            <a class="btn btn-light" href="{{URL::to('/home')}}"
                style="color: black;font-size:16px;">Recommended</a>
            <a class="btn btn-secondary" href="{{URL::to('/home-popular')}}"
                style="color: white;font-size:16px;">Popular</a>
        </div>
        <div class="container">
            <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 g-4">
                            @foreach($book_popular as $key => $book_popular_item)
                            <?php
                            if(is_null($book_popular_item->book_cover_photo)){
                                $book_popular_item->book_cover_photo = "book.jpg";
                            }
                            date_default_timezone_set('Asia/Ho_Chi_Minh');
                            $current_date = time();
                            $current_time = date("Y-m-d",$current_date);
                            ...
                            <div class="col">
                                <div class="card h-100" style="width: 16rem;margin:auto;">
                                    <a href="{{URL::to('/book-detail-show-new/'.$book_popular_item->id)}}"><img
                                            src="{{URL::to('book/'.$book_popular_item->book_cover_photo)}}"
                                            class="card-img-top" alt="..."></a>
                                    <div class="card-body">
                                        <strong style="font-size:14px">{{$book_popular_item->book_title}}</strong>
                                        <p class="card-text">{{$book_popular_item->author_name}}</p>
                                    </div>
                                    <div class="card-footer">
                                        <?php
                                    if(is_null($book_popular_item->discount_price)){
                                        echo '$'.$book_popular_item->book_price;
                                    } else{
                                        if(is_null($book_popular_item->discount_end_date) || (($current_time >= $book_popular_item->discount_start_date)&& ($current_time <= $book_popular_item->discount_end_date))){
                                            echo '<del>$'.$book_popular_item->book_price.'</del> $'.$book_popular_item->discount_price;
                                        } else {
                                            echo '$'.$book_popular_item->book_price;
                                        }
                                    }
