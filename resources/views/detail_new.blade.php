                ...
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-8">
                        <div class="shadow-none p-3 mb-5 bg-light rounded">
                            <p><strong style="font-size:20px;">Customer Reviews</strong> (Filtered by star)</p>
                            <h1>{{$average}} Star</h1>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col col-sm-3 col-lg-3">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            ...
                                            <li><a class="dropdown-item"
                                                    href="{{URL::to('/book-detail-show-old/'.$book->id)}}">Sort by date:
                                                    oldest to newest </a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="col col-sm-1 col-lg-1">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li><a class="dropdown-item"
                                                    href="{{URL::to('/book-detail-show-new/'.$book->id)}}">Show 20</a>
                                            </li>
                                            <li><a class="dropdown-item"
                                                    href="{{URL::to('/book-detail-show-new-15/'.$book->id)}}">Show
                                                    15</a>
                                            </li>
                                            <li><a class="dropdown-item"
                                                    href="{{URL::to('/book-detail-show-new-10/'.$book->id)}}">Show
                                                    10</a>
                                            </li>
                                            <li><a class="dropdown-item"
                                                    href="{{URL::to('/book-detail-show-new-5/'.$book->id)}}">Show 5</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
