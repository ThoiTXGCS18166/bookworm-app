...
<p style="margin-top:25px;margin-left:50px;margin-bottom:25px;"><strong style="font-size:20px;">Books</strong>
    (Filtered by Rating Review 5 Star)</p>
                ...
                <div class="col-6 col-sm-6 col-lg-2">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            <li><a class="dropdown-item" href="{{URL::to('/book-rating-5-star/')}}">Sort
                                    by on sale </a>
                            </li>
                            <li><a class="dropdown-item" href="{{URL::to('/book-rating-5-star/popularity')}}">Sort
                                    by popularity</a>
                            </li>
                            <li><a class="dropdown-item" href="{{URL::to('/book-rating-5-star/high')}}">Sort
                                    by price: low to high </a>
                            </li>
                            <li><a class="dropdown-item" href="{{URL::to('/book-rating-5-star/low')}}">Sort
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            <li><a class="dropdown-item"
                                    href="{{URL::to('/book-rating-5-star-sort/'.$sort_type_id)}}">Show 25</a></li>
                            <li><a class="dropdown-item"
                                    href="{{URL::to('/book-rating-5-star-sort-show-20/'.$sort_type_id)}}">Show 20</a>
                            </li>
                            <li><a class="dropdown-item"
                                    href="{{URL::to('/book-rating-5-star-sort-show-15/'.$sort_type_id)}}">Show 15</a>
                            </li>
                            <li><a class="dropdown-item"
                                    href="{{URL::to('/book-rating-5-star-sort-show-5/'.$sort_type_id)}}">Show 5</a></li>
                        </ul>
                    </div>
                </div>
            </div>
